...
//
// /*
// Used to manually deploy asset chaincode.
...
// {
//
//     tracing.create('ENTER', 'POST blockchain/chaincode/assets', {});
//
...
// }
//
// function update_config(name, res) //Updates config.asset_name (ID of Chaincode) depending on chaincode provided
// {
...
//         }
//
//         let toMatch = 'config.asset_name = \''+ configFile.config.asset_name+'\';';
//         let re = new RegExp(toMatch, 'g');
//
//         let result = data.replace(re, 'config.asset_name = \''+name+'\';');
//
